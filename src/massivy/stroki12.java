...
public class stroki12 {
    public static void main(String[] args) {
        String slovo = new String("java");
        String text = "Java is a general-purpose computer-programming "
        ...
        slovo, slova[0], slovo.equalsIgnoreCase(slova[0])); 
      System.out.printf("Используем compareTo(%s,%s) = %s%n",
        slovo, slova[0], slovo.compareTo(slova[0])); 
    }
